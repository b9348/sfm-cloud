export default function Home() {
  return (
    <main style={{ padding: '40px', fontFamily: 'system-ui' }}>
      <h1>SFM Cloud API</h1>
      <p>Next.js API Routes Backend</p>
      ...
      <ul>
        ...
        <li>PUT /api/mods/update - Update mod (requires auth)</li>
        <li>DELETE /api/mods/delete - Delete mod (requires auth)</li>
      </ul>
      ...
      <h2>Health Check:</h2>
      <ul>
        <li>GET /api/health - Database connection check</li>
      </ul>
